	...
	<section class="w3l-about-breadcrumb text-center">
	  <div class="breadcrumb-bg breadcrumb-bg-about py-sm-5 py-4">
	      <div class="container py-2">
	          <h5 class="title" style="font-family: 'Spoqa Han Sans Neo'; color:white;">문의하기</h5>
	          <ul class="breadcrumbs-custom-path mt-2">
	              <li><a href="../" style="font-family: 'Spoqa Han Sans Neo';">Home</a></li>
	              <li class="active"><span class="fa fa-arrow-right mx-2" aria-hidden="true" style="font-family: 'Spoqa Han Sans Neo';"></span>Q & A</li>
	          </ul>
	      </div>
	  </div>
	</section>
...
<!--**********************************
        ...
        ***********************************-->
        ...
        <div class="content-body" style="width:70%; margin:auto; margin-top:3%; margin-bottom:3%;">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="text" name="member_name" class="form-control" style="font-family: 'Spoqa Han Sans Neo';" placeholder="이름" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="email" name="member_email" class="form-control" style="font-family: 'Spoqa Han Sans Neo';" placeholder="이메일" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="text" name="phone" class="form-control" style="font-family: 'Spoqa Han Sans Neo';"  placeholder="번호" required>
                                            </div>
                                        </div>
                                    </div>
                                </section>
...
<script>
  ...
  function refresh(event){
    ...
    <script src="../assets/js/admin/plugins-init/jquery-steps-init.js"></script>
	</body>
</html>